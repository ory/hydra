...
func (p *Persister) createDeviceAuthSession(ctx context.Context, deviceCodeSignature, userCodeSignature string, requester fosite.DeviceRequester, table tableName, expiresAt time.Time) error {
...
func (p *Persister) findDeviceAuthSessionByDeviceCodeSignature(ctx context.Context, signature string, session fosite.Session) (fosite.DeviceRequester, error) {
	r := DeviceRequestSQL{}
...
func (p *Persister) findDeviceAuthSessionByUserCodeSignature(ctx context.Context, signature string, session fosite.Session) (fosite.DeviceRequester, error) {
	r := DeviceRequestSQL{}
...
func (p *Persister) findDeviceAuthSessionByRequestID(ctx context.Context, requestID string, session fosite.Session) (fosite.DeviceRequester, string, error) {
	r := DeviceRequestSQL{}
...
func (p *Persister) CreateDeviceAuthSession(ctx context.Context, deviceCodeSignature, userCodeSignature string, requester fosite.DeviceRequester) (err error) {
	...
	defer otelx.End(span, &err)
	return p.createDeviceAuthSession(ctx, deviceCodeSignature, userCodeSignature, requester, sqlTableDeviceAuthCodes, requester.GetSession().GetExpiresAt(fosite.DeviceCode).UTC())
}
...
func (p *Persister) GetDeviceCodeSession(ctx context.Context, signature string, session fosite.Session) (_ fosite.DeviceRequester, err error) {
	...
	defer otelx.End(span, &err)
	return p.findDeviceAuthSessionByDeviceCodeSignature(ctx, signature, session)
}
...
func (p *Persister) GetDeviceCodeSessionByRequestID(ctx context.Context, requestID string, session fosite.Session) (_ fosite.DeviceRequester, deviceCodeSignature string, err error) {
	...
	defer otelx.End(span, &err)
	return p.findDeviceAuthSessionByRequestID(ctx, requestID, session)
}
...
func (p *Persister) GetUserCodeSession(ctx context.Context, signature string, session fosite.Session) (_ fosite.DeviceRequester, err error) {
	...
	return p.findDeviceAuthSessionByUserCodeSignature(ctx, signature, session)
}
