...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.MembersRequest = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
   ...
   * @module model/MembersRequest
   * @version Latest
   */

  /**
   * Constructs a new <code>MembersRequest</code>.
   * @alias module:model/MembersRequest
   * @class
   */
   ...
   * @param {module:model/MembersRequest} obj Optional instance to populate.
   * @return {module:model/MembersRequest} The populated <code>MembersRequest</code> instance.
   */
