...
serve:
  ...
  public:
    ...
    cors:
      ...
      #
      allowed_headers:
        - minim commodo ut nulla
        - ea aute do officia in
  ...
  admin:
    ...
    cors:
      ...
      #
      exposed_headers:
        - reprehenderit et sint officia
        - ut qui in est ipsum
        - voluptate eu adipisicing deserunt sint
    ...
    socket:
      ...
      #
      group: cupidatat deserunt labore
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: https://vGbnl.rxhmumKIl,MblIvqILsaRi9WINuV2yRFcg
