...
type Flow struct {
	...
	//
	// required: true
	ID  string    `db:"login_challenge" json:"a"`
	NID uuid.UUID `db:"nid" json:"b"`

	// RequestedScope contains the OAuth 2.0 Scope requested by the OAuth 2.0 Client.
	//
	// required: true
	RequestedScope sqlxx.StringSliceJSONFormat `db:"requested_scope" json:"c,omitempty"`

	// RequestedAudience contains the access token audience as requested by the OAuth 2.0 Client.
	//
	// required: true
	RequestedAudience sqlxx.StringSliceJSONFormat `db:"requested_at_audience" json:"d,omitempty"`
	...
	//
	// required: true
	LoginSkip bool `db:"login_skip" json:"e,omitempty"`
	...
	//
	// required: true
	Subject string `db:"subject" json:"f,omitempty"`
	...
	OpenIDConnectContext *OAuth2ConsentRequestOpenIDConnectContext `db:"oidc_context" json:"g"`

	// Client is the OAuth 2.0 Client that initiated the request.
	//
	// required: true
	Client   *client.Client `db:"-" json:"h,omitempty"`
	ClientID string         `db:"client_id" json:"i,omitempty"`
	...
	//
	// required: true
	RequestURL string `db:"request_url" json:"j,omitempty"`
	...
	SessionID sqlxx.NullString `db:"login_session_id" json:"k,omitempty"`

	// IdentityProviderSessionID is the session ID of the end-user that authenticated.
	// If specified, we will use this value to propagate the logout.
	IdentityProviderSessionID sqlxx.NullString `db:"identity_provider_session_id" json:"l,omitempty"`

	LoginVerifier string `db:"login_verifier" json:"m,omitempty"`
	LoginCSRF     string `db:"login_csrf" json:"n,omitempty"`

	LoginInitializedAt sqlxx.NullTime `db:"login_initialized_at" json:"o,omitempty"`
	RequestedAt        time.Time      `db:"requested_at" json:"p,omitempty"`
	...
	LoginExtendSessionLifespan bool `db:"login_extend_session_lifespan" json:"t,omitempty"`

	// ACR sets the Authentication AuthorizationContext Class Reference value for this authentication session. You can use it
	// to express that, for example, a user authenticated using two factor authentication.
	ACR string `db:"acr" json:"u,omitempty"`
	...
	AMR sqlxx.StringSliceJSONFormat `db:"amr" json:"v,omitempty"`
	...
	ForceSubjectIdentifier string `db:"forced_subject_identifier" json:"w,omitempty"`

	// Context is an optional object which can hold arbitrary data. The data will be made available when fetching the
	// consent request under the "context" field. This is useful in scenarios where login and consent endpoints share
	// data.
	Context sqlxx.JSONRawMessage `db:"context" json:"x"`
	...
	LoginWasUsed bool `db:"login_was_used" json:"y,omitempty"`

	LoginError           *RequestDeniedError `db:"login_error" json:"z,omitempty"`
	LoginAuthenticatedAt sqlxx.NullTime      `db:"login_authenticated_at" json:"aa,omitempty"`

	// ConsentChallengeID is the identifier ("authorization challenge") of the consent authorization request. It is used to
	// identify the session.
	//
	// required: true
	ConsentChallengeID sqlxx.NullString `db:"consent_challenge_id" json:"ab,omitempty"`
	...
	ConsentSkip     bool             `db:"consent_skip" json:"ac,omitempty"`
	ConsentVerifier sqlxx.NullString `db:"consent_verifier" json:"ad,omitempty"`
	ConsentCSRF     sqlxx.NullString `db:"consent_csrf" json:"ae,omitempty"`

	// GrantedScope sets the scope the user authorized the client to use. Should be a subset of `requested_scope`.
	GrantedScope sqlxx.StringSliceJSONFormat `db:"granted_scope" json:"af,omitempty"`

	// GrantedAudience sets the audience the user authorized the client to use. Should be a subset of `requested_access_token_audience`.
	GrantedAudience sqlxx.StringSliceJSONFormat `db:"granted_at_audience" json:"ag,omitempty"`
	...
	ConsentRemember bool `db:"consent_remember" json:"ah,omitempty"`

	// ConsentRememberFor sets how long the consent authorization should be remembered for in seconds. If set to `0`, the
	// authorization will be remembered indefinitely.
	ConsentRememberFor *int `db:"consent_remember_for" json:"ai"`

	// ConsentHandledAt contains the timestamp the consent request was handled.
	ConsentHandledAt sqlxx.NullTime `db:"consent_handled_at" json:"aj,omitempty"`

	// ConsentWasHandled set to true means that the request was already handled.
	// This can happen on form double-submit or other errors. If this is set we
	// recommend redirecting the user to `request_url` to re-initiate the flow.
	ConsentWasHandled  bool                     `db:"consent_was_used" json:"ak,omitempty"`
	ConsentError       *RequestDeniedError      `db:"consent_error" json:"al"`
	SessionIDToken     sqlxx.MapStringInterface `db:"session_id_token" faker:"-" json:"am"`
	SessionAccessToken sqlxx.MapStringInterface `db:"session_access_token" faker:"-" json:"an"`
}
