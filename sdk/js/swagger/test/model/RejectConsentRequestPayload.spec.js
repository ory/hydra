...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.RejectConsentRequestPayload();
  });
  ...
  describe('RejectConsentRequestPayload', function() {
    it('should create an instance of RejectConsentRequestPayload', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.RejectConsentRequestPayload();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.RejectConsentRequestPayload);
    });
