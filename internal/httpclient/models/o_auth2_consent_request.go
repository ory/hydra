...
// Validate validates this o auth2 consent request
func (m *OAuth2ConsentRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2ConsentRequest) validateAmr(formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) validateChallenge(formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) validateClient(formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) validateOidcContext(formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) validateRequestedAccessTokenAudience(formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) validateRequestedScope(formats strfmt.Registry) error {
...
// ContextValidate validate this o auth2 consent request based on the context it is used
func (m *OAuth2ConsentRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2ConsentRequest) contextValidateAmr(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) contextValidateClient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) contextValidateOidcContext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) contextValidateRequestedAccessTokenAudience(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) contextValidateRequestedScope(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2ConsentRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OAuth2ConsentRequest) UnmarshalBinary(b []byte) error {
	var res OAuth2ConsentRequest
