...
func TestJWKSDK(t *testing.T) {
	...
	t.Run("JSON Web Key", func(t *testing.T) {
		...
		t.Run("GetJwkSetKey after create", func(t *testing.T) {
			result, _, err := sdk.V1Api.AdminGetJsonWebKey(ctx, "set-foo", expectedKid).Execute()
			require.NoError(t, err)
		...
		t.Run("UpdateJwkSetKey", func(t *testing.T) {
			...
			resultKey, _, err := sdk.V1Api.AdminUpdateJsonWebKey(ctx, "set-foo", expectedKid).JsonWebKey(resultKeys.Keys[0]).Execute()
			require.NoError(t, err)
		...
		t.Run("DeleteJwkSetKey after delete", func(t *testing.T) {
			_, err := sdk.V1Api.AdminDeleteJsonWebKey(ctx, "set-foo", expectedKid).Execute()
			require.NoError(t, err)
		})

		t.Run("GetJwkSetKey after delete", func(t *testing.T) {
			_, res, err := sdk.V1Api.AdminGetJsonWebKey(ctx, "set-foo", expectedKid).Execute()
			require.Error(t, err)
	...
	t.Run("JWK Set", func(t *testing.T) {
		...
		resultKeys, _, err := sdk.V1Api.AdminGetJsonWebKeySet(ctx, "set-foo2").Execute()
		...
		t.Run("UpdateJwkSet", func(t *testing.T) {
			...
			result, _, err := sdk.V1Api.AdminUpdateJsonWebKeySet(ctx, "set-foo2").JsonWebKeySet(*resultKeys).Execute()
			require.NoError(t, err)
			require.Len(t, result.Keys, 1)
		...
		t.Run("DeleteJwkSet", func(t *testing.T) {
			_, err := sdk.V1Api.AdminDeleteJsonWebKeySet(ctx, "set-foo2").Execute()
			require.NoError(t, err)
		})

		t.Run("GetJwkSet after delete", func(t *testing.T) {
			_, res, err := sdk.V1Api.AdminGetJsonWebKeySet(ctx, "set-foo2").Execute()
			require.Error(t, err)
			assert.Equal(t, http.StatusNotFound, res.StatusCode)
		})

		t.Run("GetJwkSetKey after delete", func(t *testing.T) {
			_, res, err := sdk.V1Api.AdminGetJsonWebKey(ctx, "set-foo2", expectedKid).Execute()
			require.Error(t, err)
			assert.Equal(t, http.StatusNotFound, res.StatusCode)
		})
	})
