...
flag: `hydra --config path/to/config.yaml`. The specified file will be used as a configuration file which supports all configuration settings listed below.
...
serve:
  ...
  public:
    ...
    cors:
      ...
      #
      allowed_headers:
        - cillum quis commodo officia tempor
        - incididunt sit
        - ullamco magna do proident esse
        - cupidatat Lorem sunt Ut dolore
      ...
      exposed_headers:
        - aute in esse
        - proident elit
        - ex laborum Lorem dolore
        - ut mollit elit Lorem Ut
    ...
    socket:
      ...
      #
      owner: ea consequat dolor laboris
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: http://UWBwutBgrOVkycAaQwHcUeGcjplDSGIEI.xsivnlyA1RdLAwhiSHad.gXZTVQQbMQU1J9Y7536sLNUbl7uAl5BlaHKUtjD,
...
#    > set VERSION=<value>
#
version: v0.1288.972230132-3.785ueyYXY
