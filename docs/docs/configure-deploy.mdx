...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.9.0-alpha.4.pre.0 help serve
...
$ docker run -it --rm \
  --network hydraguide \
  oryd/hydra:v1.9.0-alpha.4.pre.0 \
  migrate sql --yes $DSN
...
$ docker run -d \
  ...
  oryd/hydra:v1.9.0-alpha.4.pre.0 serve all
...
$ docker run -d \
  ...
  oryd/hydra:v1.9.0-alpha.4.pre.0 serve all --config /hydra.yaml
```
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.9.0-alpha.4.pre.0 help
