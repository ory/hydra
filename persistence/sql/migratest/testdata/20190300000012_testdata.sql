...
VALUES
('auth_session-0012', '2022-02-15 22:20:21', 'subject-0012', false);
...
SELECT 'challenge-0012', 'verifier-0012', hydra_client.id, 'subject-0012', 'http://request/0012', true, 'requested_scope-0012_1', 'csrf-0012', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0012"}', 'requested_audience-0012_1', 'auth_session-0012'
FROM hydra_client
...
SELECT 'challenge-0012', 'verifier-0012', hydra_client.id, 'subject-0012', 'http://request/0012', true, 'requested_scope-0012_1', 'csrf-0012', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0012"}', 'force_subject_id-0012', 'auth_session-0012', 'challenge-0012', 'requested_audience-0012_1', 'acr-0012', '{"context": "0012"}'
FROM hydra_client
ORDER BY hydra_client.pk DESC
LIMIT 1;
...
VALUES
('challenge-0012', 'granted_scope-0012_1', true, 0012, '{}', '2022-02-15 22:20:21', '{"session_access_token-0012": "0012"}', '{"session_id_token-0012": "0012"}', '2022-02-15 22:20:21', true, 'granted_audience-0012_1');
...
VALUES
('challenge-0012', 'subject-0012', true, 0012, '{}', 'acr-0012', '2022-02-15 22:20:21', '2022-02-15 22:20:21', true, 'force_subject_id-0012', '{"context": "0012"}');
