  ...
  public:
    ...
    cors:
      ...
      allowed_headers:
        ...
        - cupidatat commodo exercitation quis
        - ea dolor
    ...
    socket:
      ...
      #
      group: ut labore esse qui dolor
  ...
  admin:
    ...
    cors:
      ...
      exposed_headers:
        - aute nulla do anim
        - quis Duis veniam
        - sed fugiat dolore pariatur esse
        - laborum
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: https://lfnLdVH.qrmzxkfGVh0Ncupc
```
