---
id: before-oauth2
title: Read This Before Becoming an OAuth2 or OpenID Connect Provider!
---
...
another. It would be crazy if some app acould just log you out of GitHub, or if
...
and session management in first-party scenarios. It goes even farther than
