...
*/
func (a *AdminApiService) AdminVerifyUserCodeRequest(ctx context.Context) ApiAdminVerifyUserCodeRequestRequest {
	return ApiAdminVerifyUserCodeRequestRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AdminApiService) AdminVerifyUserCodeRequestExecute(r ApiAdminVerifyUserCodeRequestRequest) (*SuccessfulOAuth2RequestResponse, *http.Response, error) {
	var (
