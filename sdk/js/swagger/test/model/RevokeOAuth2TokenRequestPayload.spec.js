...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.RevokeOAuth2TokenRequestPayload();
  });
  ...
  describe('RevokeOAuth2TokenRequestPayload', function() {
    it('should create an instance of RevokeOAuth2TokenRequestPayload', function() {
      // uncomment below and update the code to test RevokeOAuth2TokenRequestPayload
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.RevokeOAuth2TokenRequestPayload();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.RevokeOAuth2TokenRequestPayload);
    });
