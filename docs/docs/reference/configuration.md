...
serve:
  ...
  public:
    ...
    cors:
      ...
      exposed_headers:
        - Lorem velit tempor
        - elit consequat sunt minim officia
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: http://zNBknhnYFCuEuE.xbclz0fhsQ5gRsfdlKWwCqmTi--vPdMPtlx
```
