...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerRevokeOAuth2TokenParametersBody();
  });
  ...
  describe('SwaggerRevokeOAuth2TokenParametersBody', function() {
    it('should create an instance of SwaggerRevokeOAuth2TokenParametersBody', function() {
      // uncomment below and update the code to test SwaggerRevokeOAuth2TokenParametersBody
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerRevokeOAuth2TokenParametersBody();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerRevokeOAuth2TokenParametersBody);
    });
