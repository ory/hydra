...
VALUES
('auth_session-0011', '2022-02-15 22:20:21', 'subject-0011', false);
...
SELECT 'challenge-0011', 'verifier-0011', hydra_client.id, 'subject-0011', 'http://request/0011', true, 'requested_scope-0011_1', 'csrf-0011', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0011"}', 'requested_audience-0011_1', 'auth_session-0011'
FROM hydra_client
...
SELECT 'challenge-0011', 'verifier-0011', hydra_client.id, 'subject-0011', 'http://request/0011', true, 'requested_scope-0011_1', 'csrf-0011', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0011"}', 'force_subject_id-0011', 'auth_session-0011', 'challenge-0011', 'requested_audience-0011_1', 'acr-0011', '{"context": "0011"}'
FROM hydra_client
ORDER BY hydra_client.pk DESC
LIMIT 1;
...
VALUES
('challenge-0011', 'granted_scope-0011_1', true, 0011, '{}', '2022-02-15 22:20:21', '{"session_access_token-0011": "0011"}', '{"session_id_token-0011": "0011"}', '2022-02-15 22:20:21', true, 'granted_audience-0011_1');
...
VALUES
('challenge-0011', 'subject-0011', true, 0011, '{}', 'acr-0011', '2022-02-15 22:20:21', '2022-02-15 22:20:21', true, 'force_subject_id-0011', '{"context": "0011"}');
