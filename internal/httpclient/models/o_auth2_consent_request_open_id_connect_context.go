...
// Validate validates this o auth2 consent request open ID connect context
func (m *OAuth2ConsentRequestOpenIDConnectContext) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this o auth2 consent request open ID connect context based on context it is used
func (m *OAuth2ConsentRequestOpenIDConnectContext) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *OAuth2ConsentRequestOpenIDConnectContext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OAuth2ConsentRequestOpenIDConnectContext) UnmarshalBinary(b []byte) error {
	var res OAuth2ConsentRequestOpenIDConnectContext
