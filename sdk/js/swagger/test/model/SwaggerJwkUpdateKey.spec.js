...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkUpdateKey();
  });
  ...
  describe('SwaggerJwkUpdateKey', function() {
    it('should create an instance of SwaggerJwkUpdateKey', function() {
      // uncomment below and update the code to test SwaggerJwkUpdateKey
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkUpdateKey();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkUpdateKey);
    });
