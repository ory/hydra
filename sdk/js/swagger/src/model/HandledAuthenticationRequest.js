...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryHydra.HandledAuthenticationRequest = factory(root.OryHydra.ApiClient);
  }
  ...
  /**
   * The HandledAuthenticationRequest model module.
   * @module model/HandledAuthenticationRequest
   * @version latest
   */

  /**
   * Constructs a new <code>HandledAuthenticationRequest</code>.
   * @alias module:model/HandledAuthenticationRequest
   * @class
  ...
  /**
   * Constructs a <code>HandledAuthenticationRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HandledAuthenticationRequest} obj Optional instance to populate.
   * @return {module:model/HandledAuthenticationRequest} The populated <code>HandledAuthenticationRequest</code> instance.
   */
