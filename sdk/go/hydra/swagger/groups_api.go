 ...
 * @return void
 */
func (a GroupsApi) AddMembersToGroup(id int64, body MembersRequest) (*APIResponse, error) {
 ...
 * @return *Group
 */
func (a GroupsApi) CreateGroup() (*Group, *APIResponse, error) {
 ...
 * @return void
 */
func (a GroupsApi) DeleteGroup(id int64) (*APIResponse, error) {
 ...
 * @return []string
 */
func (a GroupsApi) FindGroupsByMember(member int64) ([]string, *APIResponse, error) {
 ...
 * @return *Group
 */
func (a GroupsApi) GetGroup(id int64) (*Group, *APIResponse, error) {
 ...
 * @return void
 */
func (a GroupsApi) RemoveMembersFromGroup(id int64, body MembersRequest) (*APIResponse, error) {
