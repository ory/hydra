...
class Client implements ArrayAccess
{
    ...
    /**
     * Sets created_at
     * @param \DateTime $created_at CreatedAt returns the timestamp of the client's creation. Format: date-time Format: date-time Format: date-time Format: date-time
     * @return $this
     */
    ...
    /**
     * Sets updated_at
     * @param \DateTime $updated_at UpdatedAt returns the timestamp of the last update. Format: date-time Format: date-time Format: date-time Format: date-time
     * @return $this
     */
