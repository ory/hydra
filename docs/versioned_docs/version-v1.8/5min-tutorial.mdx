...
<img alt="OAuth2 Flow" src={useBaseUrl('img/docs/oauth2-flow.gif')} />

<p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/tlO9p2E501A" frameborder="0" allowfullscreen /></p>
