...
describe('The "account-viewer" role (act_1 member)', () => {

  const sub = 'account-viewer';
  let action;
  let resourceName;
  let response;
  ...
  describe('HTTP "POST"', () => {
    ...
    describe('context "/accounts"', () => {
      ...
      it('is NOT allowed access to "/act_1/actions/add-user"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:actions:add-user', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/act_1/users/usr_1"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:users:usr_1', c1, false, done);
      });
    ...
    describe('context "/brands" (brd_1: act_1, brd_2: act_2)', () => {
      it('is NOT allowed access to "/brd_1/analytics/campaigns/bychannel/facebook"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:analytics:campaigns:bychannel:facebook', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/brd_1/audiences"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:audiences', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/brd_1/audiences/aud_1/snapshots"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:audiences:aud_1:snapshots', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/brd_1/snapshot-fb-export-facebook-account"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:snapshot-fb-export-facebook-account', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/brd_1/sites"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:sites', c1, false, done);
      });
    ...
    describe('context "/roles" (rle_1: bridg-admin, rle_2: account-admin, usr_1: act_1, usr_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/rle_2/users/usr_1"', (done) => {
        testWardenResponse('create', 'rn:bridg:roles:999165f9-0e78-42d8-ba72-feb8ee96655d:users:499165f9-0e78-42d8-ba72-feb8ee966666', c1, false, done);
      });
    ...
    describe('context "/sites" (ste_1: act_1 - brd_1, ste_2: act_2 - brd_2)', () => {
      ...
      it('is NOT allowed access to "/ste_1/location-links"', (done) => {
        testWardenResponse('create', 'rn:bridg:accounts:act_1:brands:brd_1:sites:ste_1:location-links', c1, false, done);
      });
    ...
    describe('context "/users" (usr_1: act_1, usr_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/usr_1/actions/confirm-account-activation"', (done) => {
        testWardenResponse('create', 'rn:bridg:users:usr_1:actions:confirm-account-activation', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/usr_1/actions/confirm-password-reset"', (done) => {
        testWardenResponse('create', 'rn:bridg:users:usr_1:actions:confirm-password-reset', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/usr_1/actions/request-password-reset"', (done) => {
        testWardenResponse('create', 'rn:bridg:users:usr_1:actions:request-password-reset', c1, false, done);
      });
  ...
  describe('HTTP "PUT"', () => {
    ...
    describe('context "/accounts"', () => {
      ...
      it('is NOT allowed access to "/act_1/actions/edit-user"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:actions:edit-user', c1, false, done);
      });
    ...
    describe('context "/brands" (brd_1: act_1, brd_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/brd_1/audiences/aud_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:brands:brd_1:audiences:aud_1', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/brd_1/audiences/aud_1/snapshot-fb-exports/exp_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:brands:brd_1:audiences:aud_1:snapshot-fb-exports:exp_1', c1, false, done);
      });
    ...
    describe('context "/sites" (ste_1: act_1 - brd_1, ste_2: act_2 - brd_2)', () => {
      it('is NOT allowed access to "/ste_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:brands:brd_1:sites:ste_1', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/ste_1/location-links/ll_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:accounts:act_1:brands:brd_1:sites:ste_1:location-links:ll_1', c1, false, done);
      });
    ...
    describe('context "/users" (usr_1: act_1, usr_2: act_2)', () => {
      it('is NOT allowed access to "/usr_1"', (done) => {
        testWardenResponse('update', 'rn:bridg:users:usr_1', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/usr_1/change-email"', (done) => {
        testWardenResponse('update', 'rn:bridg:users:usr_1:change-email', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/usr_1/change-password"', (done) => {
        testWardenResponse('update', 'rn:bridg:users:usr_1:change-password', c1, false, done);
      });
  ...
  describe('HTTP "DELETE"', () => {
    ...
    describe('context "/accounts"', () => {
      it('is NOT allowed access to "/act_1/actions/remove-user"', (done) => {
        testWardenResponse('delete', 'rn:bridg:accounts:act_1:actions:remove-user', c1, false, done);
      });
      ...
      it('is NOT allowed access to "/act_1/users/usr_1"', (done) => {
        testWardenResponse('delete', 'rn:bridg:accounts:act_1:users:usr_1', c1, false, done);
      });
    ...
    describe('context "/roles" (rle_1: bridg-admin, rle_2: account-admin, usr_1: act_1, usr_2: act_2)', () => {
      ...
      it('is NOT allowed access to "/rle_2/users/usr_1"', (done) => {
        testWardenResponse('delete', 'rn:bridg:roles:999165f9-0e78-42d8-ba72-feb8ee96655d:users:499165f9-0e78-42d8-ba72-feb8ee966666', c1, false, done);
      });
