...
VALUES
	('15-challenge', '15-verifier', '15-client', '15-subject', '15-redirect', false, '15-scope', '15-csrf', NOW(), NOW(), '{}', '15-login-session-id', '15-aud');

INSERT INTO
	hydra_oauth2_consent_request (challenge, verifier, client_id, subject, request_url, skip, requested_scope, csrf, authenticated_at, requested_at, oidc_context, forced_subject_identifier, login_session_id, login_challenge, requested_at_audience, acr, context, username)
VALUES
	('15-challenge', '15-verifier', '15-client', '15-subject', '15-redirect', false, '15-scope', '15-csrf', NOW(), NOW(), '{}', '15-forced-sub', '15-login-session-id', '15-challenge', '15-aud', '15-acr', '{"foo":"bar"}', '15-username');
...
VALUES
	('15-challenge', '15-scope', true, 3600, '{}', NOW(), '{}', '{}', NOW(), false, '15-aud', NOW());

INSERT INTO
	hydra_oauth2_authentication_request_handled (challenge, subject, remember, remember_for, error, acr, requested_at, authenticated_at, was_used, forced_subject_identifier, context, username)
VALUES
	('15-challenge', '15-sub', true, 3600, '{}', '1', NOW(), NOW(), false, '15-forced-sub', '{"foo":"bar"}', '15-username');

INSERT INTO
	hydra_oauth2_obfuscated_authentication_session (subject, client_id, subject_obfuscated)
VALUES
	('15-sub', '15-client', '15-obfuscated');
...
VALUES
	('15-challenge', '15-verifier', '15-subject', '15-session-id', '15-client', 'https://request-url/', 'https://redirect-url', false, false, false, false);

INSERT INTO
	hydra_oauth2_logout_request (challenge, verifier, subject, sid, client_id, request_url, redir_url, was_used, accepted, rejected, rp_initiated)
VALUES
	('15-1-challenge', '15-1-verifier', '15-1-subject', '15-1-session-id', NULL, 'https://request-url/', 'https://redirect-url', false, false, false, false);
