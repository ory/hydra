...
serve:
  ...
  public:
    ...
    cors:
      ...
      #
      allowed_headers:
        - eu in labore exercitation ipsum
        - dolor anim ullamco veniam voluptate
        - Duis ad Ut do
      ...
      #
      exposed_headers:
        - nisi exercitation cupidatat nostrud
        - aliqua
        - nulla dolor qui
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: https://FjxFCXlTETYUalzFaqMDKNQ.ebysBsK96X2FT,o-jtgw6V
```
