...
**ExtendSessionLifespan** | Pointer to **bool** | ExtendSessionLifespan, if set to true, session cookie expiry time will be updated when session is refreshed (login skip&#x3D;true). | [optional] 
