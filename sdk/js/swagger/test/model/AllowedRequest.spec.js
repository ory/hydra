...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.AllowedRequest();
  });
  ...
  describe('AllowedRequest', function() {
    it('should create an instance of AllowedRequest', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.AllowedRequest();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.AllowedRequest);
    });
