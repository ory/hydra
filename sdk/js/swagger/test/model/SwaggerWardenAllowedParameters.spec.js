...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedParameters();
  });
  ...
  describe('SwaggerWardenAllowedParameters', function() {
    it('should create an instance of SwaggerWardenAllowedParameters', function() {
      // uncomment below and update the code to test SwaggerWardenAllowedParameters
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedParameters();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedParameters);
    });
