...
```
$ docker run -it --entrypoint hydra oryd/hydra:latest help
...
Next we need to connect to ORY Hydra and set up OAuth 2.0 Clients and access control üolicies. In particular
