...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenTokenAllowedResponseBody();
  });
  ...
  describe('SwaggerWardenTokenAllowedResponseBody', function() {
    it('should create an instance of SwaggerWardenTokenAllowedResponseBody', function() {
      // uncomment below and update the code to test SwaggerWardenTokenAllowedResponseBody
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenTokenAllowedResponseBody();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenTokenAllowedResponseBody);
    });
