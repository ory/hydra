...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.5.0-beta.5 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.5.0-beta.5 serve all
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.5.0-beta.5 help
...
<img alt="Insecure connection" src={useBaseUrl('/images/docs/hydra/insecure-connection.png')} />;
...
<img alt="OAuth 2.0 result" src={useBaseUrl('/images/docs/hydra/install-result.png')} />;
