...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.CreateJsonWebKeySetPayload();
  });
  ...
  describe('CreateJsonWebKeySetPayload', function() {
    it('should create an instance of CreateJsonWebKeySetPayload', function() {
      // uncomment below and update the code to test CreateJsonWebKeySetPayload
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.CreateJsonWebKeySetPayload();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.CreateJsonWebKeySetPayload);
    });
