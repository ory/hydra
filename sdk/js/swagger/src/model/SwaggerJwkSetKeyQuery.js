...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkSetKeyQuery = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The SwaggerJwkSetKeyQuery model module.
   * @module model/SwaggerJwkSetKeyQuery
   * @version Latest
   */

  /**
   * Constructs a new <code>SwaggerJwkSetKeyQuery</code>.
   * @alias module:model/SwaggerJwkSetKeyQuery
   * @class
  ...
  /**
   * Constructs a <code>SwaggerJwkSetKeyQuery</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggerJwkSetKeyQuery} obj Optional instance to populate.
   * @return {module:model/SwaggerJwkSetKeyQuery} The populated <code>SwaggerJwkSetKeyQuery</code> instance.
   */
