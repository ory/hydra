...
// RefreshTokenHookResponse RefreshTokenHookResponse RefreshTokenHookResponse RefreshTokenHookResponse is the response body received from the refresh token hook.
//
