...
VALUES
	('4-request', '4-verifier', '4-client', '4-subject', '4-redirect', false, '4-scope', '4-csrf', NOW(), NOW(), '{}', '4-login-session-id', '4-aud');
...
VALUES
	('4-request', '4-verifier', '4-client', '4-subject', '4-redirect', false, '4-scope', '4-csrf', NOW(), NOW(), '{}', '4-forced-sub', '4-login-session-id', '4-request', '4-aud', '4-acr');
...
VALUES
	('4-request', '4-scope', true, 3600, '{}', NOW(), '{}', '{}', NOW(), false, '4-aud');
