...
// Introspection Introspection Introspection Introspection contains an access token's session data as specified by IETF RFC 7662, see:
//
...
func (m *Introspection) validateActive(formats strfmt.Registry) error {
