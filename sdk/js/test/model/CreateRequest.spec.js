...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.CreateRequest();
  });
  ...
  describe('CreateRequest', function() {
    it('should create an instance of CreateRequest', function() {
      // uncomment below and update the code to test CreateRequest
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.CreateRequest();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.CreateRequest);
    });
