...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Client', 'model/OpenIDConnectContext'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Client'), require('./OpenIDConnectContext'));
  } else {
    // Browser globals (root is window)
    if (!root.OryHydra) {
      root.OryHydra = {};
    }
    root.OryHydra.AuthenticationRequest = factory(root.OryHydra.ApiClient, root.OryHydra.Client, root.OryHydra.OpenIDConnectContext);
  }
}(this, function(ApiClient, Client, OpenIDConnectContext) {
  'use strict';
