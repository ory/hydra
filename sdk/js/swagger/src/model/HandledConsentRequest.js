...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConsentRequestSessionData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConsentRequestSessionData'));
  } else {
    // Browser globals (root is window)
    if (!root.OryHydra) {
      root.OryHydra = {};
    }
    root.OryHydra.HandledConsentRequest = factory(root.OryHydra.ApiClient, root.OryHydra.ConsentRequestSessionData);
  }
}(this, function(ApiClient, ConsentRequestSessionData) {
  'use strict';
  ...
  /**
   * The HandledConsentRequest model module.
   * @module model/HandledConsentRequest
   * @version latest
   */

  /**
   * Constructs a new <code>HandledConsentRequest</code>.
   * @alias module:model/HandledConsentRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>HandledConsentRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HandledConsentRequest} obj Optional instance to populate.
   * @return {module:model/HandledConsentRequest} The populated <code>HandledConsentRequest</code> instance.
   */
