...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.SwaggerWardenAllowedResponseBody();
  });
  ...
  describe('SwaggerWardenAllowedResponseBody', function() {
    it('should create an instance of SwaggerWardenAllowedResponseBody', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.SwaggerWardenAllowedResponseBody();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.SwaggerWardenAllowedResponseBody);
    });
