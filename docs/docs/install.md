...
```shell
$ docker pull oryd/hydra:v1.9.0-rc.0
$ docker run --rm -it oryd/hydra:v1.9.0-rc.0 help
```
...
```shell
$ bash <(curl https://raw.githubusercontent.com/ory/hydra/v1.9.0-rc.0/install.sh) -b . v1.9.0-rc.0
$ ./hydra help
```
