...
type Config struct {
	...
	// omitted from the resulting access token. The zero value (false) copies the assertion audience into the
	// access token; the Ory Hydra configuration default is true (omit), see driver/config.
