...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.SwaggerWardenTokenAllowedResponseBody();
  });
  ...
  describe('SwaggerWardenTokenAllowedResponseBody', function() {
    it('should create an instance of SwaggerWardenTokenAllowedResponseBody', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.SwaggerWardenTokenAllowedResponseBody();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.SwaggerWardenTokenAllowedResponseBody);
    });
