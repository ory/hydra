...
VALUES
	('1-challenge', '1-verifier', '1-client', '1-subject', '1-redirect', false, '1-scope', '1-csrf', NOW(), NOW(), '{}', '1-login-session-id', '1-aud');
...
VALUES
	('1-challenge', '1-verifier', '1-client', '1-subject', '1-redirect', false, '1-scope', '1-csrf', NOW(), NOW(), '{}', '1-forced-sub', '1-login-session-id', '1-challenge', '1-aud', '1-acr');
...
VALUES
	('1-challenge', '1-scope', true, 3600, '{}', NOW(), '{}', '{}', NOW(), false, '1-aud');
...
VALUES
	('1-sig', '1-request', NOW(), '1-client', '1-scope', '1-granted-scope', '', '{}', '1-subject', true, '1-challengeed-aud', '1-granted-aud', '1-challenge');
