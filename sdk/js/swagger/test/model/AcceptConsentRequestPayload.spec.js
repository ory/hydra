...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.AcceptConsentRequestPayload();
  });
  ...
  describe('AcceptConsentRequestPayload', function() {
    it('should create an instance of AcceptConsentRequestPayload', function() {
      // uncomment below and update the code to test AcceptConsentRequestPayload
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.AcceptConsentRequestPayload();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.AcceptConsentRequestPayload);
    });
