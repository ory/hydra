...
This tutorial walks you through a quick setup of Ory Hydra 
and an exemplary User Login & Consent App based on Docker Compose. You
...
This command adds support for PostgreSQL. If you wish to use another database backend, 
you can run this command to use MySQL:
