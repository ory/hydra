...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateKey = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient, root.HydraOAuth2OpenIdConnectServer100Aplha1.CreateRequest);
  }
  ...
  /**
   * The SwaggerJwkCreateKey model module.
   * @module model/SwaggerJwkCreateKey
   * @version Latest
   */

  /**
   * Constructs a new <code>SwaggerJwkCreateKey</code>.
   * @alias module:model/SwaggerJwkCreateKey
   * @class
  ...
  /**
   * Constructs a <code>SwaggerJwkCreateKey</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggerJwkCreateKey} obj Optional instance to populate.
   * @return {module:model/SwaggerJwkCreateKey} The populated <code>SwaggerJwkCreateKey</code> instance.
   */
