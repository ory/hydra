...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.WardenTokenAllowedBody = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The WardenTokenAllowedBody model module.
   * @module model/WardenTokenAllowedBody
   * @version Latest
   */

  /**
   * Constructs a new <code>WardenTokenAllowedBody</code>.
   * @alias module:model/WardenTokenAllowedBody
   * @class
   */
  ...
  /**
   * Constructs a <code>WardenTokenAllowedBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WardenTokenAllowedBody} obj Optional instance to populate.
   * @return {module:model/WardenTokenAllowedBody} The populated <code>WardenTokenAllowedBody</code> instance.
   */
