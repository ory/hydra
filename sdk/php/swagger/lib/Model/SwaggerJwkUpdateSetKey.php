 ...
 *
 * @category    Class
 * @description SwaggerJwkUpdateSetKey swagger jwk update set key
 * @package     Hydra\SDK
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SwaggerJwkUpdateSetKey implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'swaggerJwkUpdateSetKey';
    ...
    protected static $swaggerTypes = [
        'body' => '\Hydra\SDK\Model\SwaggerJSONWebKey',
        'kid' => 'string',
        'set' => 'string'
    ];
    ...
    /**
     * Sets body
     * @param \Hydra\SDK\Model\SwaggerJSONWebKey $body
     * @return $this
     */
