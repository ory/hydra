...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.Context();
  });
  ...
  describe('Context', function() {
    it('should create an instance of Context', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.Context();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.Context);
    });
