...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.MembersRequest();
  });
  ...
  describe('MembersRequest', function() {
    it('should create an instance of MembersRequest', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.MembersRequest();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.MembersRequest);
    });
