...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.ConsentRequestClient();
  });
  ...
  describe('ConsentRequestClient', function() {
    it('should create an instance of ConsentRequestClient', function() {
      // uncomment below and update the code to test ConsentRequestClient
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.ConsentRequestClient();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.ConsentRequestClient);
    });
