 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Swaggeroauth2TokenResponse implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'swaggeroauth2TokenResponse';
    ...
    /**
     * Sets client_id
     * @param string $client_id refresh token
     * @return $this
     */
    ...
    /**
     * Sets redirect_uri
     * @param string $redirect_uri expires in
     * @return $this
     */
