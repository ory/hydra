...
serve:
  ...
  public:
    ...
    cors:
      ...
      allowed_headers:
        - laboris
        - cupidatat minim reprehenderit fugiat
        - nisi aliqua consectetur voluptate aliquip
      ...
      exposed_headers:
        - in
        - quis
        - Excepteur reprehenderit nulla amet aute
  ...
  admin:
    ...
    cors:
      ...
      #
      exposed_headers:
        - ut exercitation cupidatat Ut magna
        - amet
...
#    > set DSN=<value>
#
dsn: incididunt eiusmod amet consectetur
