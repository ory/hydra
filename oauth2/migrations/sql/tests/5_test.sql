...
VALUES
	('5-request', '5-verifier', '5-client', '5-subject', '5-redirect', false, '5-scope', '5-csrf', NOW(), NOW(), '{}', '5-login-session-id', '5-aud');
...
VALUES
	('5-request', '5-verifier', '5-client', '5-subject', '5-redirect', false, '5-scope', '5-csrf', NOW(), NOW(), '{}', '5-forced-sub', '5-login-session-id', '5-request', '5-aud', '5-acr');
...
VALUES
	('5-request', '5-scope', true, 3600, '{}', NOW(), '{}', '{}', NOW(), false, '5-aud');
