...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkSetQuery();
  });
  ...
  describe('SwaggerJwkSetQuery', function() {
    it('should create an instance of SwaggerJwkSetQuery', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkSetQuery();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkSetQuery);
    });
