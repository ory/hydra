...
// OidcConfiguration OpenID Connect Discovery ;etadata
//
...
// Validate validates this oidc configuration
func (m *OidcConfiguration) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OidcConfiguration) validateAuthorizationEndpoint(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateIDTokenSignedResponseAlg(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateIDTokenSigningAlgValuesSupported(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateIssuer(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateJwksURI(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateResponseTypesSupported(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateSubjectTypesSupported(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateTokenEndpoint(formats strfmt.Registry) error {
...
func (m *OidcConfiguration) validateUserinfoSignedResponseAlg(formats strfmt.Registry) error {
...
// ContextValidate validates this oidc configuration based on context it is used
func (m *OidcConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *OidcConfiguration) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OidcConfiguration) UnmarshalBinary(b []byte) error {
	var res OidcConfiguration
