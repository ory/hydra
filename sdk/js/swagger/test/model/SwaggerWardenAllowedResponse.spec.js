...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponse();
  });
  ...
  describe('SwaggerWardenAllowedResponse', function() {
    it('should create an instance of SwaggerWardenAllowedResponse', function() {
      // uncomment below and update the code to test SwaggerWardenAllowedResponse
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponse();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponse);
    });
