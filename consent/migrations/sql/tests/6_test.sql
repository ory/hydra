...
VALUES
	('6-challenge', '6-verifier', '6-client', '6-subject', '6-redirect', false, '6-scope', '6-csrf', NOW(), NOW(), '{}', '6-forced-sub', '6-login_session_id', '6-login-challenge', '6-aud');
...
INSERT INTO
	hydra_oauth2_consent_request_handled (challenge, granted_scope, remember, remember_for, error, requested_at, session_access_token, session_id_token, authenticated_at, was_used, granted_at_audience, acr)
VALUES
	('6-challenge', '6-scope', true, 3600, '{}', NOW(), '{}', '{}', NOW(), false, '6-aud', '6-acr');
