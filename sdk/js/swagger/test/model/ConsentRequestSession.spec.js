...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.ConsentRequestSession();
  });
  ...
  describe('ConsentRequestSession', function() {
    it('should create an instance of ConsentRequestSession', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.ConsentRequestSession();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.ConsentRequestSession);
    });
