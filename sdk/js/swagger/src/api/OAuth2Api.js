...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AcceptConsentRequestPayload', 'model/Body', 'model/ConsentRequest', 'model/InlineResponse2001', 'model/InlineResponse2002', 'model/InlineResponse401', 'model/JsonWebKeySet', 'model/RejectConsentRequestPayload', 'model/WellKnown'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AcceptConsentRequestPayload'), require('../model/Body'), require('../model/ConsentRequest'), require('../model/InlineResponse2001'), require('../model/InlineResponse2002'), require('../model/InlineResponse401'), require('../model/JsonWebKeySet'), require('../model/RejectConsentRequestPayload'), require('../model/WellKnown'));
  } else {
    // Browser globals (root is window)
    if (!root.HydraOAuth2OpenIdConnectServer100Aplha1) {
      root.HydraOAuth2OpenIdConnectServer100Aplha1 = {};
    }
    root.HydraOAuth2OpenIdConnectServer100Aplha1.Oauth2Api = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient, root.HydraOAuth2OpenIdConnectServer100Aplha1.AcceptConsentRequestPayload, root.HydraOAuth2OpenIdConnectServer100Aplha1.Body, root.HydraOAuth2OpenIdConnectServer100Aplha1.ConsentRequest, root.HydraOAuth2OpenIdConnectServer100Aplha1.InlineResponse2001, root.HydraOAuth2OpenIdConnectServer100Aplha1.InlineResponse2002, root.HydraOAuth2OpenIdConnectServer100Aplha1.InlineResponse401, root.HydraOAuth2OpenIdConnectServer100Aplha1.JsonWebKeySet, root.HydraOAuth2OpenIdConnectServer100Aplha1.RejectConsentRequestPayload, root.HydraOAuth2OpenIdConnectServer100Aplha1.WellKnown);
  }
}(this, function(ApiClient, AcceptConsentRequestPayload, Body, ConsentRequest, InlineResponse2001, InlineResponse2002, InlineResponse401, JsonWebKeySet, RejectConsentRequestPayload, WellKnown) {
  'use strict';
