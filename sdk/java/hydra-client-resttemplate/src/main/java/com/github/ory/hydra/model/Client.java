...
import com.github.ory.hydra.model.SwaggerJSONWebKeySet;
...
public class Client {
  ...
  @JsonProperty("jwks")
  private SwaggerJSONWebKeySet jwks = null;
  ...
  public Client allowedCorsOrigins(List<String> allowedCorsOrigins) {
    this.allowedCorsOrigins = allowedCorsOrigins;
    return this;
  }

  public Client addAllowedCorsOriginsItem(String allowedCorsOriginsItem) {
  ...
  **/
  ...
  public Client audience(List<String> audience) {
    this.audience = audience;
    return this;
  }

  public Client addAudienceItem(String audienceItem) {
  ...
  **/
  ...
  public Client clientSecretExpiresAt(Long clientSecretExpiresAt) {
  ...
  **/
  ...
  public Client createdAt(DateTime createdAt) {
   ...
   /**
   * CreatedAt returns the timestamp of the client&#39;s creation. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time
   * @return createdAt
  **/
  @ApiModelProperty(value = "CreatedAt returns the timestamp of the client's creation. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time")
  ...
  **/
  ...
  public Client jwks(SwaggerJSONWebKeySet jwks) {
    this.jwks = jwks;
    return this;
  }
  ...
  **/
  ...
  public SwaggerJSONWebKeySet getJwks() {
    return jwks;
  }

  public void setJwks(SwaggerJSONWebKeySet jwks) {
    this.jwks = jwks;
  }
  ...
  **/
  ...
  public Client requestObjectSigningAlg(String requestObjectSigningAlg) {
  ...
  **/
  ...
  public Client requestUris(List<String> requestUris) {
    this.requestUris = requestUris;
    return this;
  }

  public Client addRequestUrisItem(String requestUrisItem) {
  ...
  **/
  ...
  public Client sectorIdentifierUri(String sectorIdentifierUri) {
  ...
  **/
  ...
  public Client subjectType(String subjectType) {
  ...
  **/
  ...
  public Client updatedAt(DateTime updatedAt) {
   ...
   /**
   * UpdatedAt returns the timestamp of the last update. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time
   * @return updatedAt
  **/
  @ApiModelProperty(value = "UpdatedAt returns the timestamp of the last update. Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time Format: date-time")
  ...
  public Client userinfoSignedResponseAlg(String userinfoSignedResponseAlg) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.allowedCorsOrigins, client.allowedCorsOrigins) &&
        ...
        Objects.equals(this.clientSecretExpiresAt, client.clientSecretExpiresAt) &&
        ...
        Objects.equals(this.sectorIdentifierUri, client.sectorIdentifierUri) &&
        Objects.equals(this.subjectType, client.subjectType) &&
        ...
        Objects.equals(this.userinfoSignedResponseAlg, client.userinfoSignedResponseAlg);
  }
