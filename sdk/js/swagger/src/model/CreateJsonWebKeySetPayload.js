...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.CreateJsonWebKeySetPayload = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The CreateJsonWebKeySetPayload model module.
   * @module model/CreateJsonWebKeySetPayload
   * @version Latest
   */

  /**
   * Constructs a new <code>CreateJsonWebKeySetPayload</code>.
   * @alias module:model/CreateJsonWebKeySetPayload
   * @class
  ...
  /**
   * Constructs a <code>CreateJsonWebKeySetPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateJsonWebKeySetPayload} obj Optional instance to populate.
   * @return {module:model/CreateJsonWebKeySetPayload} The populated <code>CreateJsonWebKeySetPayload</code> instance.
   */
