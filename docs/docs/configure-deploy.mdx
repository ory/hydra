...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.10.3 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.10.3 serve all --config /hydra.yaml
```
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.10.3 help
