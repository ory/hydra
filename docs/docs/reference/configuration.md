...
serve:
  ...
  public:
    ...
    cors:
      ...
      exposed_headers:
        - ut nisi Lorem ea
        - officia nostrud eu nisi commodo
        - sit aliqua pariatur qui proident
  ...
  admin:
    ...
    cors:
      ...
      #
      allowed_headers:
        - in ullamco Duis tempor dolore
        - in aliquip officia dolore tempor
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: https://IsCRiSgWdHSJqPsOBzhuPgKaVunJH.uagBxaRBF.fFMXcVtawv-GBX
```
