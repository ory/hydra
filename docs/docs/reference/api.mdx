...
```json
{
  ...
  "introspection_endpoint": "https://playground.ory.sh/ory-hydra/public/oauth2/introspect",
...
<a id="tocSflushinactiveoauth2tokensrequest">
...
| introspection_endpoint                | string   | false    | none         | URL of the authorization server's OAuth 2.0 revocation endpoint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
