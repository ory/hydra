...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.JwkSet();
  });
  ...
  describe('JwkSet', function() {
    it('should create an instance of JwkSet', function() {
      // uncomment below and update the code to test JwkSet
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.JwkSet();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.JwkSet);
    });
