...
serve:
  ...
  public:
    ...
    cors:
      ...
      #
      exposed_headers:
        - ad aliqua qui ullamco
        - esse ullamco in nostrud culpa
        - minim quis commodo
  ...
  admin:
    ...
    cors:
      ...
      #
      allowed_headers:
        - dolore officia nulla commodo
        - Ut
        - ea deserunt sunt do aliquip
        - commodo cillum amet
        - culpa
