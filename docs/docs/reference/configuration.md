...
serve:
  ...
  public:
    ...
    cors:
      ...
      allowed_headers:
        - ut sunt
        - in in tempor occaecat
        - fugiat
        - sunt magna velit enim occaecat
  ...
  admin:
    ...
    cors:
      ...
      exposed_headers:
        - labore
        - Duis cupidatat aliqua sunt
        - cupidatat Ut dolor ut aliqua
        - nisi dolore non pariatur
