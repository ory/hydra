...
In this document, you will learn how to implement the Login Endpoint using our ORY Hydra SDKs.
...
The Login HTML Form cannot be a Signle Page App (Client-side browser application) or a Mobile App! It has to be
...
hydraAdmin.rejectLoginRequest(challenge, {
  error: 'user_banned',
