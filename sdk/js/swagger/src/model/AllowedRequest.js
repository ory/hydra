...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.AllowedRequest = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The AllowedRequest model module.
   * @module model/AllowedRequest
   * @version Latest
   */

  /**
   * Constructs a new <code>AllowedRequest</code>.
   * @alias module:model/AllowedRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AllowedRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllowedRequest} obj Optional instance to populate.
   * @return {module:model/AllowedRequest} The populated <code>AllowedRequest</code> instance.
   */
