...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateSetKey();
  });
  ...
  describe('SwaggerJwkCreateSetKey', function() {
    it('should create an instance of SwaggerJwkCreateSetKey', function() {
      // uncomment below and update the code to test SwaggerJwkCreateSetKey
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateSetKey();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateSetKey);
    });
