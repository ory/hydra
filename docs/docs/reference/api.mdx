...
| »» challenge                             | string                                                    | true     | none         | Challenge is the identifier ("authorization challenge") of the consent authorization request. It is used to identify the session.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
_JSONRawMessage represents a json.RawMessage that works well with JSON, SQL, and Swagger._
...
_It is important that this model object is named JSONWebKey for
...
_It is important that this model object is named JSONWebKeySet for
"swagger generate spec" to generate only on definition of a
...
effectively written in the swagger spec._
...
| Name                            | Type                                                        | Required | Restrictions | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------------- | ----------------------------------------------------------- | -------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| challenge                       | string                                                      | true     | none         | Challenge is the identifier ("login challenge") of the login request. It is used to identify the session.                                                                                                                                                                                                                                                                                                                                                         |
