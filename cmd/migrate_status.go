...
func NewMigrateStatusCmd(slOpts []servicelocatorx.Option, dOpts []driver.OptionsModifier) *cobra.Command {
	cmd := popx.RegisterMigrateStatusFlags(&cobra.Command{
		...
		RunE:       cli.NewHandler(slOpts, dOpts).Migration.MigrateStatus,
	})
