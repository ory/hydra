...
// Validate validates this o auth2 login request
func (m *OAuth2LoginRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2LoginRequest) validateChallenge(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateClient(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateOidcContext(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateRequestURL(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateRequestedAccessTokenAudience(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateRequestedScope(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateSkip(formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) validateSubject(formats strfmt.Registry) error {
...
// ContextValidate validate this o auth2 login request based on the context it is used
func (m *OAuth2LoginRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OAuth2LoginRequest) contextValidateClient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) contextValidateOidcContext(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) contextValidateRequestedAccessTokenAudience(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) contextValidateRequestedScope(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OAuth2LoginRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OAuth2LoginRequest) UnmarshalBinary(b []byte) error {
	var res OAuth2LoginRequest
