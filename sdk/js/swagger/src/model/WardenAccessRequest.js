...
;(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryHydraCloudNativeOAuth20AndOpenIdConnectServer.WardenAccessRequest = factory(
  ...
  /**
   * Constructs a new <code>WardenAccessRequest</code>.
   ...
   * @return {module:model/WardenAccessRequest} The populated <code>WardenAccessRequest</code> instance.
   */
