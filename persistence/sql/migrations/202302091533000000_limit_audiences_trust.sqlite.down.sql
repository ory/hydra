...
(
  ...
  allow_any_subject INTEGER NOT NULL DEFAULT FALSE
...
INSERT INTO "_hydra_oauth2_trusted_jwt_bearer_issuer" (
  id, issuer, subject, scope, key_set, key_id, allow_any_subject, created_at, expires_at
) SELECT id, issuer, subject, scope, key_set, key_id, allow_any_subject, created_at, expires_at FROM "hydra_oauth2_trusted_jwt_bearer_issuer";
