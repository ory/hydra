...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer.CreateJsonWebKeySetPayload();
  });
  ...
  describe('CreateJsonWebKeySetPayload', function() {
    it('should create an instance of CreateJsonWebKeySetPayload', function() {
      ...
      //var instane = new HydraOAuth2OpenIdConnectServer.CreateJsonWebKeySetPayload();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer.CreateJsonWebKeySetPayload);
    });
