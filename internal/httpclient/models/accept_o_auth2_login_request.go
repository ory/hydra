...
// Validate validates this accept o auth2 login request
func (m *AcceptOAuth2LoginRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AcceptOAuth2LoginRequest) validateAmr(formats strfmt.Registry) error {
...
func (m *AcceptOAuth2LoginRequest) validateSubject(formats strfmt.Registry) error {
...
// ContextValidate validate this accept o auth2 login request based on the context it is used
func (m *AcceptOAuth2LoginRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AcceptOAuth2LoginRequest) contextValidateAmr(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AcceptOAuth2LoginRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AcceptOAuth2LoginRequest) UnmarshalBinary(b []byte) error {
