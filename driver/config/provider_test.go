...
func TestViperProviderValidates(t *testing.T) {
	...
	// secrets
	assert.Equal(t, []byte{0x49, 0x82, 0xdd, 0xb8, 0x8d, 0x6c, 0xdb, 0xe9, 0x43, 0xe0, 0x0, 0xb6, 0xeb, 0x22, 0x62, 0xdc, 0xe3, 0x9d, 0xf3, 0xba, 0xdd, 0x2e, 0x23, 0x2b, 0xb5, 0xdc, 0xca, 0x42, 0x75, 0xad, 0x83, 0x13}, c.GetSystemSecret())
