...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Headers', 'model/IDTokenClaims'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Headers'), require('./IDTokenClaims'));
  } else {
    // Browser globals (root is window)
    if (!root.HydraOAuth2OpenIdConnectServer100Aplha1) {
      root.HydraOAuth2OpenIdConnectServer100Aplha1 = {};
    }
    root.HydraOAuth2OpenIdConnectServer100Aplha1.Session = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient, root.HydraOAuth2OpenIdConnectServer100Aplha1.Headers, root.HydraOAuth2OpenIdConnectServer100Aplha1.IDTokenClaims);
  }
}(this, function(ApiClient, Headers, IDTokenClaims) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Claims')) {
        obj['Claims'] = IDTokenClaims.constructFromObject(data['Claims']);
      }
  ...
  /**
   * @member {module:model/IDTokenClaims} Claims
   */
