...
by default hydra doesn't return any scope but MITREid returns all associated scopes to the client. To enable this in hydra, you have set up the env variable *OAUTH2_CLIENT_CREDENTIALS_DEFAULT_GRANT_SCOPE=true*,
