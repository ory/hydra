...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.9.0-alpha.1 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.9.0-alpha.1 serve all
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.9.0-alpha.1 help
