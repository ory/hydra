...
# Formats the code
.PHONY: format
format: .bin/goimports node_modules docs/node_modules authors
...
.PHONY: authors
authors:
		printf '# AUTHORS generated by `make authors`\n\n' > ./AUTHORS
		git log --format="%an <%ae>" | sort | uniq | grep -v '^dependabot\[bot\]' >> ./AUTHORS
