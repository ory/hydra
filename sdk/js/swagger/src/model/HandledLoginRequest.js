...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryHydra.HandledLoginRequest = factory(root.OryHydra.ApiClient);
  }
  ...
  /**
   * The HandledLoginRequest model module.
   * @module model/HandledLoginRequest
   * @version latest
   */

  /**
   * Constructs a new <code>HandledLoginRequest</code>.
   * @alias module:model/HandledLoginRequest
   * @class
  ...
  /**
   * Constructs a <code>HandledLoginRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HandledLoginRequest} obj Optional instance to populate.
