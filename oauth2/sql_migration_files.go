...
func migrationsSqlCockroach9Sql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/sql/cockroach/9.sql", size: 4696, mode: os.FileMode(420), modTime: time.Unix(1557332124, 0)}
...
func migrationsSqlTests9_testSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/sql/tests/9_test.sql", size: 4205, mode: os.FileMode(420), modTime: time.Unix(1557296175, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
