...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkSetKeyQuery();
  });
  ...
  describe('SwaggerJwkSetKeyQuery', function() {
    it('should create an instance of SwaggerJwkSetKeyQuery', function() {
      // uncomment below and update the code to test SwaggerJwkSetKeyQuery
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkSetKeyQuery();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkSetKeyQuery);
    });
