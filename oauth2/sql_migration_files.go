...
func migrationsSqlPostgres9Sql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/sql/postgres/9.sql", size: 6976, mode: os.FileMode(438), modTime: time.Unix(1544622537, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func migrationsSqlTests9_testSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/sql/tests/9_test.sql", size: 3967, mode: os.FileMode(438), modTime: time.Unix(1555682455, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
