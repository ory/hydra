...
**createdAt** | **Date** | CreatedAt returns the timestamp of the client&#39;s creation. | [optional] 
...
**updatedAt** | **Date** | UpdatedAt returns the timestamp of the last update. | [optional] 
