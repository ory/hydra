...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryHydra.SwaggeruserinfoResponsePayload = factory(root.OryHydra.ApiClient);
  }
  ...
  /**
   * The SwaggeruserinfoResponsePayload model module.
   * @module model/SwaggeruserinfoResponsePayload
   * @version latest
   */

  /**
   * Constructs a new <code>SwaggeruserinfoResponsePayload</code>.
   * SwaggeruserinfoResponsePayload The userinfo response
   * @alias module:model/SwaggeruserinfoResponsePayload
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggeruserinfoResponsePayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggeruserinfoResponsePayload} obj Optional instance to populate.
