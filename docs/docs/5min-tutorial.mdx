...
You can find it in [`contrib/quickstart/5-min/hydra.yml`](https://github.com/ory/hydra/blob/master/contrib/quickstart/5-min/hydra.yml).  
...
```yml title="contrib/quickstart/5-min/hydra.yml"
serve:
cookies:
  same_site_mode: Lax
