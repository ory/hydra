...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.9.1 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.9.1 serve all --config /hydra.yaml
```
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.9.1 help
