...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.IntrospectOAuth2TokenResponsePayload = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The IntrospectOAuth2TokenResponsePayload model module.
   * @module model/IntrospectOAuth2TokenResponsePayload
   * @version Latest
   */

  /**
   * Constructs a new <code>IntrospectOAuth2TokenResponsePayload</code>.
   * @alias module:model/IntrospectOAuth2TokenResponsePayload
   * @class
   */
  ...
  /**
   * Constructs a <code>IntrospectOAuth2TokenResponsePayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/IntrospectOAuth2TokenResponsePayload} obj Optional instance to populate.
   * @return {module:model/IntrospectOAuth2TokenResponsePayload} The populated <code>IntrospectOAuth2TokenResponsePayload</code> instance.
   */
