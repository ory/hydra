...
In this document, you will learn how to implement the Logout Endpoint using our ORY Hydra SDKs.
...
The Logout HTML Form cannot be a Signle Page App (Client-side browser application) or a Mobile App! It has to be
