...
func migrationsSqlShared5Sql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/sql/shared/5.sql", size: 1462, mode: os.FileMode(420), modTime: time.Unix(1541415180, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
