...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.KeyGenerator();
  });
  ...
  describe('KeyGenerator', function() {
    it('should create an instance of KeyGenerator', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.KeyGenerator();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.KeyGenerator);
    });
