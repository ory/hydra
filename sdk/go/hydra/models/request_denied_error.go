...
// RequestDeniedError RequestDeniedError RequestDeniedError RequestDeniedError RequestDeniedError The request payload used to accept a login or consent request.
