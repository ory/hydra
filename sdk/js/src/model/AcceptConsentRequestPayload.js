...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.AcceptConsentRequestPayload = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The AcceptConsentRequestPayload model module.
   * @module model/AcceptConsentRequestPayload
   * @version Latest
   */

  /**
   * Constructs a new <code>AcceptConsentRequestPayload</code>.
   * @alias module:model/AcceptConsentRequestPayload
   * @class
   */
  ...
  /**
   * Constructs a <code>AcceptConsentRequestPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcceptConsentRequestPayload} obj Optional instance to populate.
   * @return {module:model/AcceptConsentRequestPayload} The populated <code>AcceptConsentRequestPayload</code> instance.
   */
