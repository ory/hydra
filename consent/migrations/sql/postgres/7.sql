-- +migrate Up
ALTER TABLE hydra_oauth2_authentication_request ALTER COLUMN login_session_id DROP NOT NULL;
ALTER TABLE hydra_oauth2_consent_request ALTER COLUMN login_session_id DROP NOT NULL;
