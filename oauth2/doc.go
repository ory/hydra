...
type swaggerConsentRequest struct {
	...
	// RedirectURL is the URL where the user agent should be redirected to after the consent has been
	// accepted or rejected.
	RedirectURL string `json:"redirectUrl"`

	// RequestedAuthenticationContextClassReference specifies an Authentication Context Class Reference value that identifies
	...
	RequestedAuthenticationContextClassReference []string `json:"requestedAcr"`
	...
	Prompt string `json:"requestedPrompt"`

	// RequestedMaxAge specifies the allowable elapsed time in seconds since the last time the End-User was actively
	...
	MaxAge int `json:"requestedMaxAge"`
}
