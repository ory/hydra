...
VALUES
('auth_session-0008', '2022-02-15 22:20:21', 'subject-0008');
...
SELECT 'challenge-0008', 'verifier-0008', hydra_client.id, 'subject-0008', 'http://request/0008', true, 'requested_scope-0008_1', 'csrf-0008', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0008"}', 'requested_audience-0008_1', 'auth_session-0008'
FROM hydra_client
...
SELECT 'challenge-0008', 'verifier-0008', hydra_client.id, 'subject-0008', 'http://request/0008', true, 'requested_scope-0008_1', 'csrf-0008', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0008"}', 'force_subject_id-0008', 'auth_session-0008', 'challenge-0008', 'requested_audience-0008_1', 'acr-0008', '{"context": "0008"}'
FROM hydra_client
ORDER BY hydra_client.pk DESC
LIMIT 1;
...
VALUES
('challenge-0008', 'granted_scope-0008_1', true, 0008, '{}', '2022-02-15 22:20:21', '{"session_access_token-0008": "0008"}', '{"session_id_token-0008": "0008"}', '2022-02-15 22:20:21', true, 'granted_audience-0008_1');
...
VALUES
('challenge-0008', 'subject-0008', true, 0008, '{}', 'acr-0008', '2022-02-15 22:20:21', '2022-02-15 22:20:21', true, 'force_subject_id-0008', '{"context": "0008"}');
