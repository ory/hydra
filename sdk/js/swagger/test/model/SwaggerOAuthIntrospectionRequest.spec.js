...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerOAuthIntrospectionRequest();
  });
  ...
  describe('SwaggerOAuthIntrospectionRequest', function() {
    it('should create an instance of SwaggerOAuthIntrospectionRequest', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerOAuthIntrospectionRequest();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerOAuthIntrospectionRequest);
    });
