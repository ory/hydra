...
type OpenidconnectApi struct {
	Configuration *Configuration
}

func NewOpenidconnectApi() *OpenidconnectApi {
...
func NewOpenidconnectApiWithBasePath(basePath string) *OpenidconnectApi {
	configuration := NewConfiguration()
 ...
 * @return *WellKnown
 */
func (a OpenidconnectApi) WellKnownHandler() (*WellKnown, *APIResponse, error) {
