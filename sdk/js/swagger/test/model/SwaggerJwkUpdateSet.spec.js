...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkUpdateSet();
  });
  ...
  describe('SwaggerJwkUpdateSet', function() {
    it('should create an instance of SwaggerJwkUpdateSet', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkUpdateSet();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerJwkUpdateSet);
    });
