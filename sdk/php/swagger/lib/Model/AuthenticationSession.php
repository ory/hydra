 ...
 *
 * @category    Class
 * @description AuthenticationSession AuthenticationSession AuthenticationSession AuthenticationSession authentication session
 * @package     Hydra\SDK
...
class AuthenticationSession implements ArrayAccess
{
     ...
     * @param \DateTime $authenticated_at authenticated at Format: date-time Format: date-time Format: date-time Format: date-time
     * @return $this
     */
