...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateKey();
  });
  ...
  describe('SwaggerJwkCreateKey', function() {
    it('should create an instance of SwaggerJwkCreateKey', function() {
      // uncomment below and update the code to test SwaggerJwkCreateKey
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateKey();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerJwkCreateKey);
    });
