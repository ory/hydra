...
SELECT 'challenge-0005', 'verifier-0005', hydra_client.id, 'subject-0005', 'http://request/0005', true, 'requested_scope-0005_1', 'csrf-0005', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0005"}', 'requested_audience-0005_1', 'auth_session-0005'
FROM hydra_client
...
SELECT 'challenge-0005', 'verifier-0005', hydra_client.id, 'subject-0005', 'http://request/0005', true, 'requested_scope-0005_1', 'csrf-0005', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0005"}', 'force_subject_id-0005', 'auth_session-0005', 'challenge-0005', 'requested_audience-0005_1'
FROM hydra_client
ORDER BY hydra_client.pk DESC
LIMIT 1;
...
VALUES
('challenge-0005', 'granted_scope-0005_1', true, 0005, '{}', '2022-02-15 22:20:21', '{"session_access_token-0005": "0005"}', '{"session_id_token-0005": "0005"}', '2022-02-15 22:20:21', true, 'granted_audience-0005_1');
...
VALUES
('challenge-0005', 'subject-0005', true, 0005, '{}', 'acr-0005', '2022-02-15 22:20:21', '2022-02-15 22:20:21', true, 'force_subject_id-0005');
