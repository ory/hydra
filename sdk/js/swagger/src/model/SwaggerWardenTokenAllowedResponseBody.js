...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenTokenAllowedResponseBody = factory(root.HydraOAuth2OpenIdConnectServer100Aplha1.ApiClient);
  }
  ...
  /**
   * The SwaggerWardenTokenAllowedResponseBody model module.
   * @module model/SwaggerWardenTokenAllowedResponseBody
   * @version Latest
   */

  /**
   * Constructs a new <code>SwaggerWardenTokenAllowedResponseBody</code>.
   * in: body
   * @alias module:model/SwaggerWardenTokenAllowedResponseBody
   * @class
   */
  ...
  /**
   * Constructs a <code>SwaggerWardenTokenAllowedResponseBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SwaggerWardenTokenAllowedResponseBody} obj Optional instance to populate.
   * @return {module:model/SwaggerWardenTokenAllowedResponseBody} The populated <code>SwaggerWardenTokenAllowedResponseBody</code> instance.
   */
