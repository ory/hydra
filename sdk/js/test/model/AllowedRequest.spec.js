...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.AllowedRequest();
  });
  ...
  describe('AllowedRequest', function() {
    it('should create an instance of AllowedRequest', function() {
      // uncomment below and update the code to test AllowedRequest
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.AllowedRequest();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.AllowedRequest);
    });
