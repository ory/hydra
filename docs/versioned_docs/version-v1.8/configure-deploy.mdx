...
$ docker run -it --rm --entrypoint hydra oryd/hydra:v1.8.0-pre.0 help serve
...
$ docker run -d \
  ...
  oryd/hydra:v1.8.0-pre.0 serve all
...
```shell
$ docker run --rm -it --entrypoint hydra oryd/hydra:v1.8.0-pre.0 help
