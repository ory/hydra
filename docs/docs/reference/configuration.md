...
serve:
  ...
  public:
    ...
    cors:
      ...
      exposed_headers:
        - Ut
        - esse ut adipisicing sed
        - irure ex dolor eiusmod
  ...
  admin:
    ...
    socket:
      ...
      #
      owner: cupidatat reprehenderit aliquip laborum in
...
tracing:
  ...
  providers:
    ...
    zipkin:
      ...
      #
      server_url: https://DcLKXNmWjWHxkqf.oxG,nM7NATaiatSV.2
```
