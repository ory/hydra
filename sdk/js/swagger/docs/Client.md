...
**clientSecretExpiresAt** | **Number** | SecretExpiresAt is an integer holding the time at which the client secret will expire or 0 if it will not expire. The time is represented as the number of seconds from 1970-01-01T00:00:00Z as measured in UTC until the date/time of expiration.  This feature is currently not supported and it&#39;s value will always be set to 0. | [optional] 
...
**createdAt** | **Date** | CreatedAt returns the timestamp of the client&#39;s creation. Format: date-time | [optional] 
...
**updatedAt** | **Date** | UpdatedAt returns the timestamp of the last update. Format: date-time | [optional] 
