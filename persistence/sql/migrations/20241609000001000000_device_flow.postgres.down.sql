ALTER TABLE hydra_oauth2_device_auth_codes DROP CONSTRAINT IF EXISTS hydra_oauth2_device_auth_codes_challenge_id_fk;
ALTER TABLE hydra_oauth2_device_auth_codes DROP CONSTRAINT IF EXISTS hydra_oauth2_device_auth_codes_client_id_fk;
ALTER TABLE hydra_oauth2_device_auth_codes DROP CONSTRAINT IF EXISTS hydra_oauth2_device_auth_codes_nid_fk_idx;
