...
VALUES
('auth_session-0009', '2022-02-15 22:20:21', 'subject-0009');
...
SELECT 'challenge-0009', 'verifier-0009', hydra_client.id, 'subject-0009', 'http://request/0009', true, 'requested_scope-0009_1', 'csrf-0009', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0009"}', 'requested_audience-0009_1', 'auth_session-0009'
FROM hydra_client
...
SELECT 'challenge-0009', 'verifier-0009', hydra_client.id, 'subject-0009', 'http://request/0009', true, 'requested_scope-0009_1', 'csrf-0009', '2022-02-15 22:20:21', '2022-02-15 22:20:21', '{"display": "display-0009"}', 'force_subject_id-0009', 'auth_session-0009', 'challenge-0009', 'requested_audience-0009_1', 'acr-0009', '{"context": "0009"}'
FROM hydra_client
ORDER BY hydra_client.pk DESC
LIMIT 1;
...
VALUES
('challenge-0009', 'granted_scope-0009_1', true, 0009, '{}', '2022-02-15 22:20:21', '{"session_access_token-0009": "0009"}', '{"session_id_token-0009": "0009"}', '2022-02-15 22:20:21', true, 'granted_audience-0009_1');
...
VALUES
('challenge-0009', 'subject-0009', true, 0009, '{}', 'acr-0009', '2022-02-15 22:20:21', '2022-02-15 22:20:21', true, 'force_subject_id-0009', '{"context": "0009"}');
