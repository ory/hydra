...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerRevokeOAuth2TokenParameters();
  });
  ...
  describe('SwaggerRevokeOAuth2TokenParameters', function() {
    it('should create an instance of SwaggerRevokeOAuth2TokenParameters', function() {
      ...
      //var instane = new OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerRevokeOAuth2TokenParameters();
      //expect(instance).to.be.a(OryHydraCloudNativeOAuth20AndOpenIdConnectServer.SwaggerRevokeOAuth2TokenParameters);
    });
