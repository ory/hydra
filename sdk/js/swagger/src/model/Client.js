...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OryHydra.Client = factory(root.OryHydra.ApiClient, root.OryHydra.SwaggerJSONWebKeySet);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('jwks')) {
        obj['jwks'] = SwaggerJSONWebKeySet.constructFromObject(data['jwks']);
      }
  ...
  /**
   * @member {module:model/SwaggerJSONWebKeySet} jwks
   */
