...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponseBody();
  });
  ...
  describe('SwaggerWardenAllowedResponseBody', function() {
    it('should create an instance of SwaggerWardenAllowedResponseBody', function() {
      // uncomment below and update the code to test SwaggerWardenAllowedResponseBody
      //var instane = new HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponseBody();
      //expect(instance).to.be.a(HydraOAuth2OpenIdConnectServer100Aplha1.SwaggerWardenAllowedResponseBody);
    });
