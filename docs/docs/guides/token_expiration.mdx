---
id: token_expiration
title: Configuring Access Token Expiration Time
---
...
`login_consent_request` configures how long a user login and consent flow may take.
...
#....
 ...
 #....
```
`access_token` configures how long access tokens are valid.
...
#....
  ...
  access_token: 1h
   #....
```
`refresh_token` configures how long refresh tokens are valid. Set to -1 for refresh tokens to never expire.
...
#....
  ...
  refresh_token: "-1"
    #....
``` 
`id_token` configures how long id tokens are valid.
...
#.... 
  ...
  id_token: 1h
     #....
```
`auth_code` configures how long auth codes are valid.
